...
REDIS_URL = os.getenv("REDIS_URL", default="redis://localhost:6379") #default redis url
...
LLM_ACTION = int(os.getenv("LLM_ACTION", default=1))
PRINT_MAP = int(os.getenv("PRINT_MAP", default=0))
TEST_RUN = int(os.getenv("TEST_RUN", default=0))
ALLOW_PLAN = int(os.getenv("ALLOW_PLAN", default=1))
